...
*       public interface Serializable {
  ...
  *         com.bjpowernode.javase.bean.Student;Local class incompatible:
...
*       小鹏编写了一个类：com.bjpowernode.javase.bean.Student implements Serializable
*       小张编写了一个类：com.bjpowernode.javase.bean.Student implements Serializable
