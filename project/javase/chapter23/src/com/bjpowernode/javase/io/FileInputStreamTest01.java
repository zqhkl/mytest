...
public class FileInputStreamTest01 {
    public static void main(String[] args) {
        ...
        try {
            //创建文件字节输入流对象
            //文件路径：D:\javase-进阶\temp.txt（IDEA会自动把\编程\\,因为Java中\表示转义）
            //以下都是采用了绝对路径的方式。
            //FileInputStream fis = new FileInputStream("D:\\javase-进阶\\temp.txt");
            //写成这个‘/’也是可以的。
             fis = new FileInputStream("D:/javase-进阶/temp.txt");
